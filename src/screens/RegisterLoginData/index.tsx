...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const loginsTransformed = storagedData ? JSON.parse(storagedData) as FormData[] : [];

    loginsTransformed.push(newLoginData);

    // Save data on AsyncStorage and navigate to 'Home' screen    
    await AsyncStorage.setItem(dataKey, JSON.stringify(loginsTransformed));
    reset();
    navigate('Home');
  }
